...
urlpatterns = [
    ...
    path('turno/form/', views.TurnoCreate.as_view(), name="turno_form"),
    ...
    path('entrenamiento/list/', views.EntrenamientoList.as_view(), name="entrenamiento_list"),
    path('entrenamiento/form/', views.EntrenamientoCreate.as_view(), name="entrenamiento_form"),
    path('entrenamiento/update/<int:pk>/', views.EntrenamientoUpdate.as_view(), name="entrenamiento_update"),
    path('entrenamiento/delete/<int:pk>/', views.EntrenamientoDelete.as_view(), name="entrenamiento_delete"),
    ...
    path('rutina/form/<int:pk>/', views.rutina_form, name='rutina_form'),
